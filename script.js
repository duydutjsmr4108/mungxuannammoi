...
showButton.addEventListener("click", function () {
    if (christmasMessage.style.display === "none") {
        christmasMessage.style.diplay = "block";
    } else {
        christmasMessage.style.display = "none";
    }
});
document.getElementById("closeButton").addEventListener("click", function () {
    document.etElementById("Mery").style.display = "block";
});


document.etElementById("showButton").addEventListener("click", function() {
...
document.getElementById("closeutton").addEventListener("click", function () {
    var guideInfo = document.getElementById("guideInfo");
    var button = document.getElementById("showButton");
            ...
            if (fire.y <= fire.far) {
                ...
                for (var j = 0; j < fireNumber * 5; j++) {
                    var firework = {
                        ...
                        ay: 0.05,
                        alpha: 1,
                        life: Math.round((ath.random() * range) / 2) + range / 2,
                        shape: fire.shape,
                    };
